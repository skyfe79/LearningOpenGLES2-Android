...
import kr.pe.burt.android.masking.glkit.BufferUtils;
...
public class Model {
  ...
  private void setupVertexBuffer() {
    ...
    vertexStride = (COORDS_PER_VERTEX + TEXCOORDS_PER_VERTEX) * SIZE_OF_FLOAT; // 4 bytes per vertex
  }
  ...
  public void draw(long dt) {
    ...
    shader.setVertexAttribute("a_TexCoord", TEXCOORDS_PER_VERTEX, GLES20.GL_FLOAT, false, vertexStride, (COORDS_PER_VERTEX) * SIZE_OF_FLOAT);
