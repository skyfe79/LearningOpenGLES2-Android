...
import kr.pe.burt.android.texture.glkit.ShaderUtils;
import kr.pe.burt.android.texture.glkit.TextureUtils;
...
public class OGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        int textureName = TextureUtils.loadTexture(context, R.drawable.razewarelogo_128);
